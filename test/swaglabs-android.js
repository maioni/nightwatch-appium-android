describe("Swaglabs Android app test", function () {
  ...
  it("Login with empty user name", async function (browser) {
    browser
      .useXpath()
  ...
  it("Login with empty password name", async function (browser) {
    browser
      .useXpath()
  ...
  it("Login with invalid user name", async function (browser) {
    browser
      .useXpath()
  ...
  it("Login with invalid password", async function (browser) {
    browser
      .useXpath()
      .setValue('//android.widget.EditText[@content-desc="test-Username"]',"standard_user")
  ...
  it("Login with blocked user", async function (browser) {
    browser
      .useXpath()
  ...
  it("Login test", async function (browser) {
    browser
      .useXpath()
      .setValue('//android.widget.EditText[@content-desc="test-Username"]',"standard_user")
      .setValue('//android.widget.EditText[@content-desc="test-Password"]',"secret_sauce")
  ...
  it("Logoff test", async function (browser) {
    browser
      .useXpath()
      .setValue('//android.widget.EditText[@content-desc="test-Username"]',"standard_user")
      .setValue('//android.widget.EditText[@content-desc="test-Password"]',"secret_sauce")
